						...
						<img src={Car} className='car img-fluid' title='Logo' />
  						...
  						<div className="collapse navbar-collapse" id="navbarNavAltMarkup">
    						<div className="navbar-nav">
      							<Link className="nav-link lola mx-2" to='listafilas'>Lista Fila</Link>
      							<Link className="nav-link lola mx-2" to='listaatendentes'>Lista Atendentes</Link>
								<Link className='nav-link lola mx-2' to='Adm'>Lista ADM</Link> 
                                <Link className='nav-link lola mx-2' to='logar'>Sair</Link>   
    						</div>
  						</div>
					</nav>
				</div>
